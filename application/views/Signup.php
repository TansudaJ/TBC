		...
		<div class="form-group">
			...
			<div class="row">
				<div class="col">
					...
					<?php echo form_input(['name' => 'fname', 'class' => 'form-control', 'value' => set_value('fname'), 'placeholder' => 'Enter First Name']); ?>
					<?php echo form_error('fname', "<div style='color:red'>", "</div>"); ?>

				</div>
				<div class="col">
					<label>Lastname</label>
					<?php echo form_input(['name' => 'lname', 'class' => 'form-control', 'value' => set_value('lname'), 'placeholder' => 'Enter Last Name']); ?>
